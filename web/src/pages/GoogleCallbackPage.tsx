  ...
  if (status === "connecting") {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        <div className="w-8 h-8 border-2 border-brain-error border-t-transparent rounded-full animate-spin" />
        <p className="text-brain-muted font-label">Connecting your Gmail account…</p>
      </div>
    );
  }
