...
1. If you don't have a Slack workspace, create one at [slack.com](https://slack.com) (free tier works)
...
> **Mac users:** If you already have Homebrew installed, use the first option. **Windows users:** use Scoop — Supabase recommends it over npm for Windows. **Linux or Mac without Homebrew:** use npm.
...
Your Open Brain is live. Now make it work for you. The companion prompt pack — *Open Brain: Companion Prompts* — covers the full lifecycle from here:
